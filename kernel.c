...
//CHARACTER PARTS
void draw_char_bar_top(int,int,int);
void draw_char_bar_btm(int,int,int);
void draw_char_bar_mid(int,int,int);
void draw_char_left_bar(int,int,int);
void draw_char_right_bar(int,int,int);
void draw_char_pipe_left(int,int,int);
void draw_char_pipe_right(int,int,int);
void draw_char_pipe_mid(int,int,int);
void draw_char_diag(int,int,int,BOOL);
void draw_char_top_left_diag(int,int,int);
void draw_char_top_right_diag(int,int,int);
void draw_char_btm_left_diag(int,int,int);
void draw_char_btm_right_diag(int,int,int);

//CURSOR INPUT
void cursor_drawc(int);
void cursor_forwd(void); 
void cursor_newln(void);

//CHARACTERS
void draw_non_char(int, int, int);
void draw_0(int,int,int);
void draw_1(int,int,int);
void draw_A(int,int,int);
void draw_B(int,int,int);
void draw_C(int,int,int);
void draw_D(int,int,int);
void draw_E(int,int,int);
void draw_F(int,int,int);
void draw_G(int,int,int);
void draw_H(int,int,int);
void draw_I(int,int,int);
void draw_J(int,int,int);
void draw_K(int,int,int);
void draw_L(int,int,int);
void draw_M(int,int,int);
void draw_N(int,int,int);
void draw_O(int,int,int);
void draw_P(int,int,int);
void draw_Q(int,int,int);
void draw_R(int,int,int);
void draw_S(int,int,int);
void draw_T(int,int,int);
void draw_U(int,int,int);
void draw_V(int,int,int);
void draw_W(int,int,int);
void draw_X(int,int,int);
void draw_Y(int,int,int);
void draw_Z(int,int,int);
